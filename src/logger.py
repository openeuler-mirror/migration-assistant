...
from abicheck.utils import format_msg_with_datetime
...
def initialize_logger(log_name, log_dir="/tmp"):
...
def _critical(self, msg, *args, **kwargs):
    if self.isEnabledFor(logging.CRITICAL):
        ...
        format_msg_with_datetime(msg, "critical"), args, **kwargs)
        sys.exit(1)
...
def _debug(self, msg, *args, **kwargs):
    if self.isEnabledFor(logging.DEBUG):
        ...
        if tool_opts.debug:
            ...
            self._log(LogLevelFile.level,
                      format_msg_with_datetime(msg, "debug"), args, **kwargs)
